...
const applicantReviews = pgTable(
  "applicant_reviews",
  {
    ...
    aUnableToGrade: varchar("a_unable_to_grade", { length: 32 }),
    aTechnicalFlag: varchar("a_technical_flag", { length: 128 }),
    ...
    bUnableToGrade: varchar("b_unable_to_grade", { length: 32 }),
    bTechnicalFlag: varchar("b_technical_flag", { length: 128 }),
