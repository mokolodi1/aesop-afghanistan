...
/**
 * @returns {Promise<Map<string, { age: string, essay: string, round2: string, round2Prompt: string, links: string, driveFileId: string, driveFileName: string, driveDurationSeconds: number|null }>|null>}
 */
 ...
 *   aSuspectedAi?: string,
 *   aUnableToGrade?: string,
 *   aTechnicalFlag?: string,
 *   aInstructionFollowing?: string,
 *   aOriginalThinking?: string,
 *   aCharacter?: string,
 *   bEnglishLevel?: string,
 *   bSuspectedAi?: string,
 *   bUnableToGrade?: string,
 *   bTechnicalFlag?: string,
...
async function upsertApplicantReviewFromMirror(fields) {
  ...
  const result = await pool.query(
    ...
    [
      ...
      fields.aSuspectedAi ?? "",
      fields.aUnableToGrade ?? "",
      fields.aTechnicalFlag ?? "",
      fields.aInstructionFollowing ?? "",
      fields.aOriginalThinking ?? "",
      fields.aCharacter ?? "",
      fields.bEnglishLevel ?? "",
      fields.bSuspectedAi ?? "",
      fields.bUnableToGrade ?? "",
      fields.bTechnicalFlag ?? "",
