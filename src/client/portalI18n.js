...
const TRANSLATIONS = {
  en: {
    ...
    'nav.faq': 'FAQ',
    'nav.tickets': 'Get help',
    'nav.operationsTickets': 'Operations tickets',
    ...
    'faq.lead': 'Answers are based on the AESOP Student Handbook for Academic Year 2026-2027. Personal decisions and exceptions must be handled by AESOP staff.',
    'faq.contactTitle': 'How do I contact AESOP?',
    'faq.contactBody': 'Log in to the student portal and create a help request. AESOP cannot provide student support through personal Signal accounts.',
    'faq.loginTitle': 'What if I cannot log in?',
    'faq.loginBody': 'Ask your teacher privately for help logging in. If needed, your teacher can contact AESOP about the login issue.',
    'faq.gradeTitle': 'Can this help page tell me my grade?',
    'faq.gradeBody': 'No. The help system does not retrieve private grade information. Use the grade area of your student portal for available grade information.',
    'faq.honorTitle': 'What is the AESOP Honor Promise?',
    'faq.honorBody': 'Submit work you did yourself. Do not use other people, translators, or AI to create or edit work unless you clearly cite any outside words, ideas, or help. Consequences can range from redoing an assignment or receiving a zero to warning, probation, or removal, depending on severity and honesty. (Handbook, pp. 1-2)',
    'faq.attendanceTitle': 'What is AESOP\'s attendance policy?',
    'faq.attendanceBody': 'Attend every class and arrive on time and prepared. An absence is unexcused when you do not inform your teacher in advance, except for a serious emergency or circumstances beyond your control. Attendance affects your grade. (Handbook, pp. 2-3)',
    'faq.absenceTitle': 'Can repeated absences remove me from AESOP?',
    'faq.absenceBody': 'A student may be dismissed after more than three weeks of accumulated absences or more than two consecutive weeks of absences, whether excused or unexcused. Students expecting to miss more than six Fall or Spring classes, or more than three Summer classes, should request leave. Ask staff about your individual situation. (Handbook, p. 3)',
    'faq.leaveEligibilityTitle': 'How do I request a Leave of Absence?',
    'faq.leaveEligibilityBody': 'Students in good academic standing must submit the official Leave of Absence Request Form, normally within the first two weeks of the semester before the leave. Emergency cases may be considered. Requests submitted after prolonged inactivity are not eligible. Create a help request for the official form or a personal decision. (Handbook, pp. 3-4)',
    'faq.leaveDurationTitle': 'How long can a Leave of Absence last?',
    'faq.leaveDurationBody': 'Leave may be granted for up to one academic semester. Multiple requests are possible, but not for consecutive semesters. Students on leave cannot continue that semester and are not eligible for financial aid, advancement, or certificates during the leave. (Handbook, p. 4)',
    'faq.classTimeTitle': 'Can I change my class time?',
    'faq.classTimeBody': 'Before a semester, submit the Class Time Form by its deadline. Students who do not submit it will be assigned a class. Class-time changes may not be requested after the form is submitted. (Handbook, pp. 4-5)',
    'faq.levelChangeTitle': 'Can I change my class level?',
    'faq.levelChangeBody': 'A request to move to a lower level must be made to administration within the first month of Fall or Spring. Moving to a higher level requires recommendations from at least two current teachers. Level changes are not allowed during Summer. (Handbook, p. 5)',
    'faq.financialAidTitle': 'Who qualifies for AESOP financial aid?',
    'faq.financialAidBody': 'AESOP provides monthly mobile-data top-ups to students in need inside Afghanistan who are active and in good academic standing. Students must attend, participate, complete assignments, follow the Honor Promise, and maintain an average of at least 70%. Individual eligibility must be confirmed by AESOP staff. (Handbook, pp. 5-6)',
    'faq.financialAidTimingTitle': 'How often are financial-aid top-ups sent?',
    'faq.financialAidTimingBody': 'Each eligible student receives one top-up per month. Report phone-number changes to AESOP administrators before a top-up is sent; AESOP will not provide another top-up when one was already sent to an old number that was not updated. (Handbook, p. 6)',
    'faq.certificateTitle': 'What grades are needed for a certificate or advancement?',
    'faq.certificateBody': 'A typical score of 60%-69% earns a certificate of completion without advancement; 70% or higher earns a certificate and advancement eligibility; and 90% or higher earns a certificate with cum laude distinction. Certificates are AESOP acknowledgements and are not externally accredited. (Handbook, p. 6)',
    'faq.volunteerTitle': 'Can an AESOP student become a volunteer teacher?',
    'faq.volunteerBody': 'Students who earn distinction in Advanced English may be considered for volunteer teaching. AESOP only rarely engages a volunteer teacher inside Afghanistan who has not earned that distinction. Selection is not automatic. (Handbook, p. 7)',
    'faq.scholarshipTitle': 'Does AESOP provide scholarships?',
    'faq.scholarshipBody': 'AESOP does not provide scholarships or guaranteed scholarship support. On special occasions, it may support student-volunteers with exceptional academic excellence, community spirit, volunteer service, and leadership. Personal eligibility must be discussed with AESOP staff. (Handbook, p. 7)',
    'faq.recommendationTitle': 'Can AESOP help with applications or recommendation letters?',
    'faq.recommendationBody': 'Exceptional student-volunteers may sometimes receive application guidance, recommendation letters, school-list help, or Duolingo English Test support, but this is never guaranteed. Students seeking letters for English-speaking institutions should expect to complete at least one semester of Advanced English. (Handbook, p. 7)',
    'faq.communicationTitle': 'Which platforms should students use?',
    'faq.communicationBody': 'AESOP uses Google Meet for classes, Google Classroom for assignments and resources, Signal for group communication, and Gmail for messages. Check messages regularly and respond to important teacher or administrative messages within 72 hours whenever reasonably possible. (Handbook, p. 7)',
    'faq.privacyTitle': 'What are the communication and privacy rules?',
    'faq.privacyBody': 'Communicate respectfully in group settings, do not record or share class content without permission, do not publish another student\'s information, and do not request personal or financial help from volunteers. Report inappropriate behavior or safety concerns to AESOP leadership through a private help request. (Handbook, pp. 2 and 8)',
    'faq.stillNeedHelp': 'Still need help? Create a help request',
    'tickets.title': 'Help requests',
    'tickets.request': 'Help request',
    'tickets.privacy': 'Your request is shared with the Operations Team, not with your teacher.',
    'tickets.loading': 'Loading…',
    'tickets.new': 'Create a new help request',
    'tickets.category': 'Category',
    'tickets.category.general': 'General question',
    'tickets.category.technical': 'Portal or technical issue',
    'tickets.category.academic': 'Academic support',
    'tickets.subject': 'Subject',
    'tickets.message': 'How can we help?',
    'tickets.create': 'Create request',
    'tickets.yourRequests': 'Your requests',
    'tickets.empty': 'You have not created any help requests.',
    'tickets.you': 'You',
    'tickets.student': 'Student',
    'tickets.operationsTeam': 'Operations Team',
    'tickets.followUp': 'Send a follow-up message',
    'tickets.send': 'Send message',
    'tickets.sending': 'Sending…',
    'tickets.notFound': 'This help request could not be found.',
    'tickets.requestNumber': 'Request #{{id}}',
    'tickets.status.open': 'Open',
    'tickets.status.waiting': 'Waiting for student',
    'tickets.status.resolved': 'Resolved',
    'tickets.status.closed': 'Closed',
    'tickets.operationsQueue': 'Operations Team help requests',
    'tickets.noAccess': 'Operations Team access is required.',
    'tickets.sentInternallyBy': 'Sent internally by {{name}}',
    'tickets.publicReply': 'Public reply',
    'tickets.publicReplyHint': 'The student will see this reply as coming from Operations Team.',
    'tickets.sendAsOperations': 'Send as Operations Team',
    'tickets.filter': 'Show requests',
    'tickets.all': 'All',
  ...
  fa: {
    ...
    'nav.tickets': 'درخواست کمک',
    'nav.operationsTickets': 'درخواست‌های تیم عملیات',
    ...
    'faq.lead': 'پاسخ‌ها بر اساس کتابچهٔ محصلان AESOP برای سال تعلیمی ۲۰۲۶-۲۰۲۷ است. تصمیم‌ها و استثناهای شخصی باید توسط کارمندان AESOP بررسی شود.',
    'faq.contactTitle': 'چگونه با AESOP تماس بگیرم؟',
    'faq.contactBody': 'وارد پورتال محصل شوید و یک درخواست کمک بسازید. AESOP نمی‌تواند از طریق حساب‌های شخصی سیگنال خدمات محصلان را ارائه کند.',
    'faq.loginTitle': 'اگر نتوانم وارد پورتال شوم چه کنم؟',
    'faq.loginBody': 'برای کمک ورود، به‌صورت خصوصی از معلم خود کمک بخواهید. در صورت نیاز، معلم شما می‌تواند دربارهٔ مشکل ورود با AESOP تماس بگیرد.',
    'faq.gradeTitle': 'آیا این صفحه می‌تواند نمره‌ام را بگوید؟',
    'faq.gradeBody': 'خیر. سیستم کمک به اطلاعات خصوصی نمره دسترسی ندارد. معلومات موجود نمره را در بخش نمرات پورتال محصل ببینید.',
    'faq.honorTitle': 'تعهد صداقت علمی AESOP چیست؟',
    'faq.honorBody': 'کاری را بسپارید که خودتان انجام داده‌اید. از افراد دیگر، مترجم یا هوش مصنوعی برای ساختن یا ویرایش کار استفاده نکنید، مگر این‌که واژه‌ها، نظریات یا کمک بیرونی را به‌روشنی منبع‌دهی کنید. پیامدها بر اساس شدت تخلف و صداقت محصل می‌تواند از بازانجام تکلیف یا نمرهٔ صفر تا اخطار، دورهٔ آزمایشی یا اخراج باشد. (کتابچه، صفحات ۱-۲)',
    'faq.attendanceTitle': 'پالیسی حاضری AESOP چیست؟',
    'faq.attendanceBody': 'در همهٔ صنف‌ها حاضر شوید و به‌موقع و آماده باشید. اگر پیش از غیابت به معلم خبر ندهید، غیابت غیرموجه شمرده می‌شود؛ مگر در حالت اضطرار جدی یا شرایط خارج از کنترول شما. حاضری بخشی از نمره است. (کتابچه، صفحات ۲-۳)',
    'faq.absenceTitle': 'آیا غیابت‌های تکراری می‌تواند باعث اخراج شود؟',
    'faq.absenceBody': 'پس از بیش از سه هفته غیابت مجموعی یا بیش از دو هفته غیابت پی‌هم، موجه یا غیرموجه، ممکن است محصل از کورس و برنامه اخراج شود. اگر انتظار دارید در خزان یا بهار بیش از شش صنف، یا در تابستان بیش از سه صنف را از دست بدهید، درخواست رخصتی کنید. برای وضعیت شخصی خود از کارمندان بپرسید. (کتابچه، صفحهٔ ۳)',
    'faq.leaveEligibilityTitle': 'چگونه رخصتی تحصیلی درخواست کنم؟',
    'faq.leaveEligibilityBody': 'محصلان دارای وضعیت خوب تحصیلی باید فورم رسمی رخصتی را معمولاً در دو هفتهٔ اول سمستر پیش از رخصتی بسپارند. موارد اضطراری ممکن است بررسی شود. درخواست پس از یک دورهٔ طولانی عدم فعالیت پذیرفته نمی‌شود. برای فورم رسمی یا بررسی شخصی، درخواست کمک بسازید. (کتابچه، صفحات ۳-۴)',
    'faq.leaveDurationTitle': 'رخصتی تحصیلی چه‌قدر دوام می‌کند؟',
    'faq.leaveDurationBody': 'رخصتی می‌تواند تا یک سمستر تعلیمی باشد. درخواست‌های متعدد ممکن است، اما نه برای سمسترهای پی‌هم. در دورهٔ رخصتی، محصل نمی‌تواند همان سمستر را ادامه دهد و واجد کمک مالی، ارتقا یا تصدیق‌نامه نیست. (کتابچه، صفحهٔ ۴)',
    'faq.classTimeTitle': 'آیا می‌توانم وقت صنفم را تغییر دهم؟',
    'faq.classTimeBody': 'پیش از آغاز سمستر، فورم وقت صنف را تا مهلت تعیین‌شده بسپارید. اگر فورم را نسپارید، صنف برای شما تعیین می‌شود. پس از سپردن فورم، درخواست تغییر وقت صنف پذیرفته نمی‌شود. (کتابچه، صفحات ۴-۵)',
    'faq.levelChangeTitle': 'آیا می‌توانم سطح صنفم را تغییر دهم؟',
    'faq.levelChangeBody': 'درخواست رفتن به سطح پایین‌تر باید در ماه اول سمستر خزان یا بهار به اداره داده شود. رفتن به سطح بالاتر به توصیهٔ حداقل دو معلم فعلی نیاز دارد. تغییر سطح در سمستر تابستان مجاز نیست. (کتابچه، صفحهٔ ۵)',
    'faq.financialAidTitle': 'چه کسی واجد کمک مالی AESOP است؟',
    'faq.financialAidBody': 'AESOP برای محصلان نیازمند داخل افغانستان که فعال و دارای وضعیت خوب تحصیلی‌اند، ماهانه بستهٔ اینترنت می‌دهد. حاضری، مشارکت، انجام تکالیف، رعایت تعهد صداقت و میانگین حداقل ۷۰٪ لازم است. واجد شرایط بودن هر فرد را کارمندان AESOP تأیید می‌کنند. (کتابچه، صفحات ۵-۶)',
    'faq.financialAidTimingTitle': 'بسته‌های کمک مالی چند وقت یک‌بار فرستاده می‌شود؟',
    'faq.financialAidTimingBody': 'هر محصل واجد شرایط ماهانه یک بسته دریافت می‌کند. تغییر شمارهٔ تلفن را پیش از ارسال بسته به اداره خبر دهید؛ اگر بسته به شمارهٔ قبلی فرستاده شده باشد و تغییر گزارش نشده باشد، بستهٔ اضافی داده نمی‌شود. (کتابچه، صفحهٔ ۶)',
    'faq.certificateTitle': 'برای تصدیق‌نامه یا ارتقا چه نمره‌ای لازم است؟',
    'faq.certificateBody': 'معمولاً نمرهٔ ۶۰٪ تا ۶۹٪ تصدیق‌نامهٔ تکمیل بدون ارتقا؛ ۷۰٪ یا بیشتر تصدیق‌نامه و امکان ارتقا؛ و ۹۰٪ یا بیشتر تصدیق‌نامه با امتیاز عالی می‌دهد. تصدیق‌نامه‌ها تأیید رسمی AESOP است و اعتبار بیرونی ندارد. (کتابچه، صفحهٔ ۶)',
    'faq.volunteerTitle': 'آیا محصل AESOP می‌تواند معلم داوطلب شود؟',
    'faq.volunteerBody': 'محصلانی که در انگلیسی پیشرفته امتیاز عالی گرفته‌اند ممکن است برای تدریس داوطلبانه در نظر گرفته شوند. انتخاب خودکار نیست و AESOP به‌ندرت فردی را در داخل افغانستان بدون این امتیاز می‌پذیرد. (کتابچه، صفحهٔ ۷)',
    'faq.scholarshipTitle': 'آیا AESOP بورسیه می‌دهد؟',
    'faq.scholarshipBody': 'AESOP بورسیه یا حمایت تضمین‌شدهٔ بورسیه ارائه نمی‌کند. در موارد ویژه ممکن است از محصل-داوطلبان دارای برتری علمی، روحیهٔ اجتماعی، خدمت داوطلبانه و رهبری حمایت کند. واجد شرایط بودن شخصی را با کارمندان بررسی کنید. (کتابچه، صفحهٔ ۷)',
    'faq.recommendationTitle': 'آیا AESOP در درخواست‌ها یا توصیه‌نامه کمک می‌کند؟',
    'faq.recommendationBody': 'محصل-داوطلبان برجسته گاهی ممکن است راهنمایی درخواست، توصیه‌نامه، فهرست مؤسسات یا حمایت آزمون انگلیسی Duolingo دریافت کنند، اما تضمین نیست. برای توصیه‌نامه به مؤسسات انگلیسی‌زبان، انتظار می‌رود حداقل یک سمستر انگلیسی پیشرفته تکمیل شده باشد. (کتابچه، صفحهٔ ۷)',
    'faq.communicationTitle': 'محصلان از کدام پلتفورم‌ها استفاده کنند؟',
    'faq.communicationBody': 'AESOP از Google Meet برای صنف، Google Classroom برای تکالیف و منابع، Signal برای ارتباط گروهی و Gmail برای پیام‌ها استفاده می‌کند. پیام‌ها را منظم بررسی کنید و تا حد امکان به پیام‌های مهم معلم یا اداره در ۷۲ ساعت پاسخ دهید. (کتابچه، صفحهٔ ۷)',
    'faq.privacyTitle': 'قواعد ارتباط و محرمیت چیست؟',
    'faq.privacyBody': 'در گروه‌ها محترمانه ارتباط بگیرید، بدون اجازه صنف را ثبت یا نشر نکنید، معلومات محصل دیگر را منتشر نکنید و از داوطلبان کمک شخصی یا مالی نخواهید. رفتار نامناسب یا نگرانی ایمنی را با یک درخواست خصوصی به رهبری AESOP گزارش دهید. (کتابچه، صفحات ۲ و ۸)',
    'faq.stillNeedHelp': 'هنوز کمک می‌خواهید؟ یک درخواست کمک بسازید',
    'tickets.title': 'درخواست‌های کمک',
    'tickets.request': 'درخواست کمک',
    'tickets.privacy': 'درخواست شما با تیم عملیات شریک می‌شود، نه با معلم شما.',
    'tickets.loading': 'در حال بارگذاری…',
    'tickets.new': 'ساخت درخواست کمک جدید',
    'tickets.category': 'دسته‌بندی',
    'tickets.category.general': 'پرسش عمومی',
    'tickets.category.technical': 'مشکل پورتال یا تخنیکی',
    'tickets.category.academic': 'کمک آموزشی',
    'tickets.subject': 'موضوع',
    'tickets.message': 'چگونه کمک کنیم؟',
    'tickets.create': 'ساخت درخواست',
    'tickets.yourRequests': 'درخواست‌های شما',
    'tickets.empty': 'هنوز درخواست کمکی نساخته‌اید.',
    'tickets.you': 'شما',
    'tickets.student': 'محصل',
    'tickets.operationsTeam': 'تیم عملیات',
    'tickets.followUp': 'ارسال پیام پیگیری',
    'tickets.send': 'ارسال پیام',
    'tickets.sending': 'در حال ارسال…',
    'tickets.notFound': 'این درخواست کمک پیدا نشد.',
    'tickets.requestNumber': 'درخواست شمارهٔ {{id}}',
    'tickets.status.open': 'باز',
    'tickets.status.waiting': 'در انتظار محصل',
    'tickets.status.resolved': 'حل‌شده',
    'tickets.status.closed': 'بسته',
    'tickets.operationsQueue': 'درخواست‌های کمک تیم عملیات',
    'tickets.noAccess': 'دسترسی تیم عملیات لازم است.',
    'tickets.sentInternallyBy': 'در داخل توسط {{name}} ارسال شد',
    'tickets.publicReply': 'پاسخ عمومی',
    'tickets.publicReplyHint': 'محصل این پاسخ را از طرف تیم عملیات خواهد دید.',
    'tickets.sendAsOperations': 'ارسال از طرف تیم عملیات',
    'tickets.filter': 'نمایش درخواست‌ها',
    'tickets.all': 'همه',
