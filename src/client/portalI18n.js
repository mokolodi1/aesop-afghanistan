...
const TRANSLATIONS = {
  en: {
    ...
    'faq.lead': 'These answers contain only confirmed portal guidance. More policy information will be added after the Student Handbook is reviewed.',
  ...
  fa: {
    ...
    'faq.lead': 'این پاسخ‌ها فقط شامل راهنمای تأییدشدهٔ پورتال است. اطلاعات پالیسی پس از بررسی کتابچهٔ محصلان اضافه می‌شود.',
