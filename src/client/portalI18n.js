...
const TRANSLATIONS = {
  en: {
    ...
    'reviews.essayWordCountHintAria': 'About the recommended essay length',
    'reviews.essayMissing': 'No essay on file.',
    'reviews.promptsSectionAria': 'Application prompts',
    'reviews.essayPromptLabel': 'Essay prompt',
    ...
    'reviews.scale.nativeFluency': 'Native fluency',
    ...
    'reviews.saveNoChangesYet': 'No changes yet (auto-save every 30 secs)',
    'reviews.saveNow': 'Save now',
    'reviews.saveNowWithAutoSave': 'Save now (auto-save every 30 sec)',
  ...
  fa: {
    ...
    'reviews.essayWordCountHintAria': 'درباره طول توصیه‌شده انشا',
    'reviews.essayMissing': 'انشا موجود نیست.',
    'reviews.promptsSectionAria': 'سؤالات درخواست',
    'reviews.essayPromptLabel': 'سؤال انشا',
    ...
    'reviews.scale.nativeFluency': 'روانی بومی',
    ...
    'reviews.saveNoChangesYet': 'هنوز تغییری نیست (ذخیره خودکار هر ۳۰ ثانیه)',
    'reviews.saveNow': 'همین حالا ذخیره کن',
    'reviews.saveNowWithAutoSave': 'همین حالا ذخیره کن (ذخیره خودکار هر ۳۰ ثانیه)',
